...
# Paste: [REDACTED_SUPABASE_ANON_KEY]

vercel env add SUPABASE_SERVICE_ROLE_KEY production
# Paste: [REDACTED_SUPABASE_SERVICE_ROLE_KEY]

vercel env add SUPABASE_JWT_SECRET production
# Paste: [REDACTED_SUPABASE_JWT_SECRET]
...
netlify env:set SUPABASE_URL "https://***REMOVED***"
netlify env:set SUPABASE_ANON_KEY "[REDACTED_SUPABASE_ANON_KEY]"
netlify env:set SUPABASE_SERVICE_ROLE_KEY "[REDACTED_SUPABASE_SERVICE_ROLE_KEY]"
...
# Set config vars
heroku config:set SUPABASE_URL="https://***REMOVED***" -a your-app-name
heroku config:set SUPABASE_ANON_KEY="[REDACTED_SUPABASE_ANON_KEY]" -a your-app-name
heroku config:set SUPABASE_SERVICE_ROLE_KEY="[REDACTED_SUPABASE_SERVICE_ROLE_KEY]" -a your-app-name
